...
# Hipotesis nula: las series X e Y siguen una distribucion normal bivariada para todo t
# hipotesis alternativa: a partior de un tiempo t0, Xi se cpomporta igual que Y pero su media cambio 
# Estadistico T = i(n-i)*Di^2*Fi/(SxSy-Sxy^2)
# con Di = [Sx(ymedio-Yi)-Sxy(Xmedio-Xi)]n/(n-i)Fi
# con Fi=Sx-ni(xi-x)^2/(N-i)
# sumatoria desde i hasta n (Xi-Xmedio)(Yi-Ymedio)
...
i<-1 
estadistico_F<-(0.09409/i)*(81/(1-0.09409))
F_critico<-qf(0.95,1,81)
...
#para ver si hay un salto voy usar el test de yamamoto el cual es praticmanete un test de medias
