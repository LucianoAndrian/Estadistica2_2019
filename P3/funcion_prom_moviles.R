...
##EL PROMEDIO PESADO ES A MANO, HACER QUE PREGUNTE SI SE QUIERE CENTRADO Y QUE ASIGNE 
##LOS PESOS DE MANERA AUTOMATICA CON EL CRITERIO USADO MAS COMUN, SI EL PROMEDIO PESADO
## NO ES CENTRADO QUE SEA A MANO
##GUARDA LAS IMAGENES, HACER QUE PREGUNTE SI SE QUIERE GUARDAR A O NO
